...
echo "<thead><tr>";
echo "<th>Environment</th><th>Server Name</th><th>JVM</th>";
echo "<input type=\"text\" name=\"envName\" id=\"envName\" size=\"30\" value=\"This will be automatically generated.\" disabled /><td>" . $value->srvname . "</td><td>" . $value->jvmname . "</td>";
